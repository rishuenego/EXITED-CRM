    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md border-border/50 bg-card/80 backdrop-blur-sm">
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">Exited Data CRM</CardTitle>
            <CardDescription className="mt-2">
              Sign in to manage employee exit data
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 rounded-lg border border-border bg-muted/50 p-4">
            ...
            <div className="mt-2 space-y-1 text-center text-sm">
              <p>
                ...
                <code className="rounded bg-background px-1">admin / admin123</code>
              </p>
              <p>
                <span className="text-muted-foreground">HR:</span>{' '}
                <code className="rounded bg-background px-1">hr / hr123</code>
              </p>
            </div>
          </div>
        </CardContent>
